    ...
    return (
        <div className="navbar mx-auto bg-slate-900 text-white">
            <div className="navbar-start">
                ...
                <div>
                    <Link to='/'><a className="btn text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-yellow-500 to-red-600  btn-ghost normal-case font-bold text-sm lg:text-xl"> TravelEase </a></Link>
                </div>
            </div>
